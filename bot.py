...
class Bot(Client):
    ...
    BotCommand("search",        "🔍 Search YouTube (song/video name)"),
    BotCommand("yt",            "🎬 Download video (30+ sites)"),
    BotCommand("yta",           "🎵 Download audio (30+ sites)"),
    BotCommand("fb",            "📘 Download Facebook video"),
    BotCommand("pin",           "📌 Download Pinterest video pin"),
    BotCommand("terabox",       "📦 Download TeraBox file"),
    BotCommand("mf",            "📁 Download Mediafire file"),
    BotCommand("gdrive",        "📂 Download Google Drive file"),
    BotCommand("mega",          "💾 Download Mega.nz file"),
    BotCommand("gofile",        "🗂️ Download GoFile.io file"),
    BotCommand("pixeldrain",    "📥 Download Pixeldrain file"),
    BotCommand("catbox",        "🐱 Download Catbox/Litterbox file"),
    BotCommand("stape",         "🎞️ Download StreamTape video"),
    BotCommand("torrent",       "🧲 Download torrent/magnet link"),
    BotCommand("gallery",       "📸 Download gallery (Twitter/Pinterest/Reddit...)"),
