...
COMMANDS_TXT = (
    ...
    f"{E_ROCKET} /yt &lt;url&gt; — Download video (💀 30+ sites: YouTube, Insta, etc.)\n"
    f"{E_ROCKET} /yta or /adl &lt;url&gt; — Extract audio (👻 30+ sites)\n"
    f"{E_ROCKET} /insta or /ig &lt;url&gt; — Download Instagram post/reel (or just paste the link)\n"
